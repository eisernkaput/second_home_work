...
public class HomeWork2 {
    ...
    private static List<Integer> duplicateIndex(Integer[] inputArr) {
        ...
        if (inputArr.length == 0) return outputList;
...
//    private static List<Integer> duplicateIndex(Integer[] inputArr) {
//        int[] duplicateIndices = new int[100];
//        int halfArrayIndex = inputArr.length / 2;
//
//        for (int i = 0; i < inputArr.length; i++) {
//            int nextIndex = i + 1;
...
//                for (int j = nextIndex; j < inputArr.length; j++) {
//                    if (Objects.equals(inputArr[i], inputArr[j])) {
//                        duplicateIndices[0] = i;
//                        duplicateIndices[1] = j;
//                        break;
//                    }
//                }
//            } else {
...
//                }
//            }
//            if (duplicateIndices[0] != 0 && duplicateIndices[1] != 0) {
//                break;
//            }
//        }
//
//        return Arrays.asList(duplicateIndices[0], duplicateIndices[1]);
//    }
